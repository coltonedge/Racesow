...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center" class="lefttd">
	<tbody><tr>
	  <td valign="bottom" align="left" colspan="2"><a href="viewforum.php?f=1" class="maintitle">Registration</a></td>
	</tr>
 </tbody></table>
 <br>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<!-- BEGIN switch_confirm -->
        <!-- deprecated in favor of more simple question
	<tr> 
         ...
         <tr>
           ...
           <td class="row2">
             <span style="font-size: small;">What is the name of the command that allows you respawn back to the starting point? Hint: in game, type "help" in the console to see the list of racesow commands. If you can't find it, ask other players in-game.
