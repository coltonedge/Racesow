...
<tr>
	...
	<tr height="26">
		<td align="left" valign="middle" nowrap="nowrap"><img src="{searchresults.MINI_POST_IMG}" width="12" height="9" alt="{searchresults.L_MINI_POST_ALT}" title="{searchresults.L_MINI_POST_ALT}" border="0" /><span class="postdetails"><span class="cat2">{L_FORUM}:&nbsp;<b><a href="{searchresults.U_FORUM}" class="cat2">{searchresults.FORUM_NAME}</a></b>&nbsp; &nbsp;{L_POSTED}: {searchresults.POST_DATE}&nbsp; &nbsp;{L_SUBJECT}: <b><a href="{searchresults.U_POST}" class="cat2">{searchresults.POST_SUBJECT}</a></b></span></span></td>
