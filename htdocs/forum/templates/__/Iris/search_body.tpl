...
<form action="{S_SEARCH_ACTION}" method="POST" style="display: inline;"><table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
...
{TPL_HDR1}<span class="cattitle">{L_SEARCH_QUERY}</span>{TPL_HDR2}<table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	...
	<tr> 
		<td class="cat2" colspan="4" align="center" height="28">{S_HIDDEN_FIELDS}<input class="liteoption" type="submit" value="{L_SEARCH}" /></td>
	</tr>
</table>{TPL_FTR}
