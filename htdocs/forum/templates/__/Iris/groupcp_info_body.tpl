...
<form action="{S_GROUPCP_ACTION}" method="post" style="display: inline;">
...
<form action="{S_GROUPCP_ACTION}" method="post" name="post" style="display: inline;">
...
<tr> 
	...
	<td class="row1" align="center" onmouseover="this.style.backgroundColor='{C_ROW1_OVER}';" onmouseout="this.style.backgroundColor='{C_ROW1}';" onclick="window.location.href='{U_MOD_VIEWPROFILE}'"><span class="gen"><a href="{U_MOD_VIEWPROFILE}" class="gen">{MOD_USERNAME}</a></span></td>
...
<tr> 
	...
	<td class="row1" align="center" onmouseover="this.style.backgroundColor='{C_ROW1_OVER}';" onmouseout="this.style.backgroundColor='{C_ROW1}';" onclick="window.location.href='{member_row.U_VIEWPROFILE}'"><span class="gen"><a href="{member_row.U_VIEWPROFILE}" class="gen">{member_row.USERNAME}</a></span></td>
...
<!-- BEGIN switch_mod_option -->
<tr>
	<td class="cat2" colspan="8" align="right"><span class="gen">
