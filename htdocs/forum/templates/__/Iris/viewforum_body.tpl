...
{TPL_HDR1}<a class="cattitle" href="{U_VIEW_FORUM}">{FORUM_NAME}</a>{TPL_HDR2}<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row1" width="100%" onmouseover="this.style.backgroundColor='{C_ROW1_OVER}';" onmouseout="this.style.backgroundColor='{C_ROW1}';" onclick="window.location.href='{topicrow.U_VIEW_TOPIC}'"><span class="topictitle">{topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span><span class="gensmall"><br />
	...
	<tr> 
	  <td class="cat2" align="center" valign="middle" colspan="6" height="26"><span class="genmed"><span class="cat2">{L_DISPLAY_TOPICS}:&nbsp;{S_SELECT_TOPIC_DAYS}&nbsp; 
