{TPL_HDR1}<span class="cattitle">{L_PREVIEW}</span>{TPL_HDR2}<table border="0" cellpadding="0" cellspacing="1" width="100%" class="forumline">
<tr>
	<td class="th" align="center" valign="middle"><table border="0" cellspacing="0" cellpadding="2" width="100%">
	<tr height="26">
		<td align="left" valign="middle" nowrap="nowrap"><img src="{T_TEMPLATE_PATH}/images/icon_minipost.gif" alt="{L_POST}" /><span class="genmed"><span class="th">{L_POSTED}: {POST_DATE}</span></span></td>
	</tr></table></td>
</tr>
<tr>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td align="left" valign="top"><img src="{T_TEMPLATE_PATH}/images/spacer.gif" width="150" height="100" border="0" alt="" /></td>
			</tr>
			</table><br /><br /></td>
