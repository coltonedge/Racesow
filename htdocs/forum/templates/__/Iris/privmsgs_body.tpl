  ...
  <tr> 
	...
	<td align="right"> 
	  ...
	  <table width="190" cellspacing="1" cellpadding="2" border="0" class="forumline">
		...
		<tr> 
		  <td colspan="3" width="190" class="row2" nowrap="nowrap"><img src="{T_TEMPLATE_PATH}/images/vote_lcap.gif" width="4" height="12" border="0" /><img src="{T_TEMPLATE_PATH}/images/voting_bar.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="12" alt="{INBOX_LIMIT_PERCENT}" /><img src="{T_TEMPLATE_PATH}/images/vote_rcap.gif" width="10" height="12" border="0" alt="" /></td>
		</tr>
		<tr> 
...
{TPL_HDR1}<span class="cattitle">{BOX_NAME}</span>{TPL_HDR2}<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td width="55%" valign="middle" class="row1" onmouseover="this.style.backgroundColor='{C_ROW1_OVER}';" onmouseout="this.style.backgroundColor='{C_ROW1}';" onclick="window.location.href='{listrow.U_READ}'"><span class="topictitle">&nbsp;<a href="{listrow.U_READ}" class="topictitle">{listrow.SUBJECT}</a></span></td>
	  <td width="20%" valign="middle" align="center" class="row2" onmouseover="this.style.backgroundColor='{C_ROW2_OVER}';" onmouseout="this.style.backgroundColor='{C_ROW2}';" onclick="window.location.href='{listrow.U_FROM_USER_PROFILE}'"><span class="name">&nbsp;<a href="{listrow.U_FROM_USER_PROFILE}" class="name">{listrow.FROM}</a></span></td>
	...
	<tr> 
	  <td class="cat2" colspan="5" height="26" align="right"> {S_HIDDEN_FIELDS} 
