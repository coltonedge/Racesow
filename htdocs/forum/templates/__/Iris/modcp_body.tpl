...
<tr> 
	...
	<tr> 
	  ...
	  <td class="row1" onmouseover="this.style.backgroundColor='{C_ROW1_OVER}';" onmouseout="this.style.backgroundColor='{C_ROW1}';" onclick="window.location.href='{topicrow.U_VIEW_TOPIC}'">&nbsp;<span class="topictitle">{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span></td>
	...
	<!-- END topicrow -->
	<tr align="right"> 
	  <td class="cat2" colspan="5" height="29"> {S_HIDDEN_FIELDS} 
