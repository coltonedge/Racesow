...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post" style="display: inline;">
...
{TPL_HDR1}<span class="cattitle">{L_REGISTRATION_INFO}</span>{TPL_HDR2}<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr> 
		<td class="cat2" colspan="2"><span class="gensmall"><span class="cat2">{L_ITEMS_REQUIRED}</span></span></td>
	</tr>
	...
	<tr> 
	  <td class="cat2" colspan="2"><span class="gensmall"><span class="cat2">{L_PROFILE_INFO_NOTICE}</span></span></td>
	</tr>
	<tr> 
	...
	<tr>
		<td class="cat2" colspan="2" align="center" height="26">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" /></td>
	</tr>
</table>{TPL_FTR}
</form>
