 ...
 *
 *   $Id: em_ftp.php,v 1.15 2005/11/10 01:57:43 markus_petrux Exp $
 *
 *
 ***************************************************************************/
...
//	$remote_filename = '../../../easymod.gif';
	...
	if( ($ftp_type == 'ext') && ($ftp_cache) )
	{
		...
		{
			$emftp->ftp_chdir('em_includes');
			$emftp->emftp_chmod('em_includes', '0777');
			$emftp->ftp_chdir('cache');
			$emftp->emftp_chmod('cache', '0777');
		}
	...
	*/
	...
	function ftp_mkdir( $dir_name)
	{
		if ($this->ftp_type == 'fsock')
		{
			...
			if ( $result )
			{
				$this->emftp_chmod($dir_name, '0777');
			}
			return $result;
		}
		else
