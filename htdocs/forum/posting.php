...
else if ( $submit || $confirm )
{
	...
	switch ( $mode )
	{
		...
		case 'reply':
			...
			$fuxxing_spam = prepare_post($mode, $post_data, $bbcode_on, $html_on, $smilies_on, $error_msg, $username, $bbcode_uid, $subject, $message, $poll_title, $poll_options, $poll_length, $forum_id, $topic_id);
