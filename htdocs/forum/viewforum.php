...
$view->headTitle($forum_row['forum_name']);
...
{
	$moderators[] = '<a href="' . append_sid("profile.$phpEx?mode=viewprofile&amp;" . POST_USERS_URL . "=" . $row['user_id']) . '">' . get_racenet_nickname($row['username']) . '</a>';
}
...
if( $total_topics )
{
	for($i = 0; $i < $total_topics; $i++)
	{
		...
		$topic_author .= ( $topic_rowset[$i]['user_id'] != ANONYMOUS ) ? get_racenet_nickname( $topic_rowset[$i]['username'] ) : ( ( $topic_rowset[$i]['post_username'] != '' ) ? get_racenet_nickname( $topic_rowset[$i]['post_username'] ) : $lang['Guest'] );
		...
		$last_post_author = ( $topic_rowset[$i]['id2'] == ANONYMOUS ) ? ( ($topic_rowset[$i]['post_username2'] != '' ) ? get_racenet_nickname( $topic_rowset[$i]['post_username2'] ) . ' ' : $lang['Guest'] . ' ' ) : '<a href="' . append_sid("profile.$phpEx?mode=viewprofile&amp;" . POST_USERS_URL . '='  . $topic_rowset[$i]['id2']) . '">' . get_racenet_nickname( $topic_rowset[$i]['user2'] ) . '</a>';
