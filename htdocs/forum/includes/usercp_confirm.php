...
$dict_location = "/srv/apache2/warsow-race.net/www/library/freecap/freecap_words";
...
$font_locations = Array(	
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_font1.gdf",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_font2.gdf",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_font3.gdf",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_font4.gdf",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_font5.gdf",
	);
...
$bg_images = Array(
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im1.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im2.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im3.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im4.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im5.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im6.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im7.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im8.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im9.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im10.jpg",
		"/srv/apache2/warsow-race.net/www/library/freecap/freecap_im11.jpg"
	);
...
////// Choose Word:
//////////////////////////////////////////////////////
// freecap wordlist is read in usercp_register.php
$_SESSION['freecap_word_hash'] = $hash_func($the_fucking_code);
$word = $the_fucking_code;
...
if($bg_type!=0)
{
	...
	if($bg_type==1)
	{
		...
		for($i=$rand_func(6,20) ; $i<$width*2 ; $i+=$rand_func(10,25))
		{
			...
			$text_r = $rand_func(1,255);
			$text_g = $rand_func(1,255);
			$text_b = $rand_func(1,255);
