...
$recaptcha_public_key = '6LdgHMkSAAAAAAxmreL4tIqGYlQ2DtpdiyE57A7j'; # You need to put your public and private key here
$recaptcha_private_key = '6LdgHMkSAAAAAMQRwUccawtGqpcLfuiBjFptiFUh';
$recaptcha_code = null;
...
//              }
                if(trim(strtolower($_POST['bonusq']))!='racerestart') {
                   $error = TRUE;
