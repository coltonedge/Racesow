...
$stmt = $pdo->query("SELECT DATE_FORMAT(created, '%Y-%m-%d') as day, COUNT(id) as num FROM race WHERE created BETWEEN '$from' AND '$to' GROUP BY day");
...
$graph->yaxis->title->Set('finished races');
